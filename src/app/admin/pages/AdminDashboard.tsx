...
const STATUS_COLOR: Record<string, string> = {
  ...
  "on-the-way": "text-[var(--tp-accent-text)]",
  ...
  const statCards = [
    {
      ...
      iconColor: "text-[var(--tp-accent-text)]",
      ...
      >
        <div className="flex items-center justify-between px-5 py-4 border-b border-[#27272A]">
          <div className="flex items-center gap-2">
            <TrendingUp className="w-4 h-4 text-[var(--tp-accent-text)]" />
            <h3 className="text-white font-semibold text-sm">Pedidos recientes</h3>
          </div>
          <button
            onClick={onNavigateOrders}
            className="text-[var(--tp-accent-text)] text-xs font-medium flex items-center gap-1 hover:text-[var(--tp-accent-text)] transition-colors"
          >
